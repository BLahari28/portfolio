...
const Portfolio = () => {
  return (
    <div className="bgimg">
      <nav>
        <ul>
          <li><a href="#home" className="logo">Lahari.</a></li>
      ...
      <div id="home" className="main">
        <div className="text">
          <h2>HEY THERE!</h2>
          <h1 style={{ margin: '5px' }}>I am <span className="Special">B.Lahari</span></h1>
          <pre style={{ fontFamily: 'Times New Roman, Times, serif' }}>But you can call me --<span className="Special"><b> lahari
            </b></span></pre>
          <p><b>I'm currently a student at Annmacharaya institution.</b></p>
          <br /><a href="lahari.docx" download>Download CV</a>
        </div>
        <div className="textcol">
          <img src="Lahari.jpg" alt="lahari"/>
        </div>
      </div>
      <section id="aboutme" className="aboutme">
        <h1>About Me</h1>
        <p style={{ textAlign: 'justify' }}>I'm Bhupalam Lahari pursuing Bachelor of Technology in <span className="special">Annmacharaya institution of technology and sciences</span> in the stream of <span className="Special">&nbsp; Electronics and Communication Engineering.</span> I am passionate about knowing</p>
        ...
        <div className="time">
          <div className="con lef">
            ...
            <div className="text-box">
              ...
              <p>I Completed my School Education at Little scholars global Englih Medium High School,Mydhukur</p>
              <p>I got 9.8 GPA in my School Education.</p>
          ...
          <div className="con rig">
            ...
            <div className="text-box">
              <h2><span className="special">MPC(maths,physics,chemistry)</span></h2>
              <small>2019-2021</small>
              <p>I Completed my Intermediate Education at Narayana junior College, Nellore.</p>
              <p>I got 9.1 GPA in my Intermediate Education.</p>
          ...
          <div className="con lef">
            ...
            <div className="text-box">
              ...
              <p>I got 8.96 CGPA in my Bachelor's Education.</p>
              <span className="lef-arr"></span>
            </div>
          </div>
        </div>
        ...
        <address>
          <div className="add">
            <div className="contact">
              ...
              <p>Address: 10/70-1,<br /> Badvelroad,<br /> Mydhukur,<br /> Kadapa(D),<br /> Andhra Pradesh state.</p>
            </div>
            <div className="contact">
              <h2><span className="special">Contact me</span></h2><hr />
              <p><b>Email:</b> <a href="bhupalamlahari1414@gmail.com">bhupalamlahari1414@gmail.com</a></p>
              <p><b>Phone:</b> <a href="tel:+91 8247391227">8247391227</a></p>
            </div>
          </div>
